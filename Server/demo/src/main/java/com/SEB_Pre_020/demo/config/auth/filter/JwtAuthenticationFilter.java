package com.SEB_Pre_020.demo.config.auth.filter;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public JwtAuthenticationFilter
            (AuthenticationManager authenticationManager, JwtTokenizer jwtTokenizer) {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        MemberLoginDto loginDto
                = objectMapper.readValue(request.getInputStream(), MemberLoginDto.class);
    ...
    private String delegateAccessToken(Member member) {
        ...
        Date expiration = jwtTokenizer.getTokenExpiration(jwtTokenizer.getAccessTokenExpiriationSeconds());
